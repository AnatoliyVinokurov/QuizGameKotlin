...
class GameLevel2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageView.setImageResource(R.drawable.main_background_level2)
        ...
        buttonStart.setOnClickListener {
            try {
                val intent = Intent(this@GameLevel2, MainActivity::class.java)
        ...
        val intent = Intent(this@GameLevel2, Level2::class.java)
